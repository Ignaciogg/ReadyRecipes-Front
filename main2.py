...
#print('knn:  {:.2f}'.format(TratamientoDatos.entrenarModelo(1, './Modelos')*100))

#print('GradientBoostedTree: {:.2f}'.format(TratamientoDatos.entrenarModelo(2, './Modelos')*100))

#print('RandomForest: {:.2f}'.format(TratamientoDatos.entrenarModelo(3, './Modelos')*100))
